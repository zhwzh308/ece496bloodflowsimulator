...
- (void)displayPixelBuffer:(CVImageBufferRef)pixelBuffer 
{
    ...
    CVReturn err = CVOpenGLESTextureCacheCreateTextureFromImage(kCFAllocatorDefault, // allocator
    ...
    // Draw the texture on the screen with OpenGL ES 3/2
